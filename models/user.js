...
const accountNameValidator = [
  ...
  validate({
    validator: 'isAscii',
    message: 'accountName should contain alphabet characters only',
  }),
];
...
const bankValidator = [
  ...
  validate({
    validator: 'isAlpha',
    message: 'bank should contain alphabet characters only',
  }),
];
...
const UserSchema = new mongoose.Schema({
  ...
  username: {
    type: String,
    required: true,
    unique: true, validate: usernameValidator
  },
  phone: {
    type: String,
    required: true,
    unique: true, validate: phoneValidator
  },
  email: {
    type: String,
    required: true,
    lowercase: true,
    unique: true, uniqueCaseInsensitive: true, validate: emailValidator
  },
